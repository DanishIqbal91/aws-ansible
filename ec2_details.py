	...
	for reservation in response["Reservations"]:
			...
			if state == 'terminated':
        		...
        		#print id,os_type,state,region,image_id,key_name,sg_name,elastic_ip,launch_time,vpc_id 
                	...
                	sql = "INSERT IGNORE INTO aws_ec2(id,os_type,region,state,elastic_ip,image_id,launch_time,key_name,vpc_id,sg_name) VALUES (%s, %s, %s, %s, %s, %s, %s,%s, %s, %s)"
